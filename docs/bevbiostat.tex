...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{birthwt}\SpecialCharTok{$}\NormalTok{race }\OtherTok{\textless{}{-}} \FunctionTok{factor}\NormalTok{(birthwt}\SpecialCharTok{$}\NormalTok{race, }\AttributeTok{levels =} \DecValTok{1}\SpecialCharTok{:}\DecValTok{3}\NormalTok{, }\AttributeTok{labels =} \FunctionTok{c}\NormalTok{(}\StringTok{"Kaukázusi"}\NormalTok{, }\StringTok{"Afroamerikai"}\NormalTok{, }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{SimData }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{idx =} \DecValTok{1}\SpecialCharTok{:}\DecValTok{100}\NormalTok{, }\AttributeTok{CI =} \FunctionTok{t}\NormalTok{(}\FunctionTok{replicate}\NormalTok{(}\DecValTok{100}\NormalTok{, TeachingDemos}\SpecialCharTok{::}\FunctionTok{z.test}\NormalTok{(}\FunctionTok{rnorm}\NormalTok{(}\DecValTok{30}\NormalTok{, }
    \DecValTok{70}\NormalTok{, }\DecValTok{10}\NormalTok{), }\AttributeTok{stdev =} \DecValTok{10}\NormalTok{)}\SpecialCharTok{$}\NormalTok{conf.int)))}
\NormalTok{Hmisc}\SpecialCharTok{::}\FunctionTok{Dotplot}\NormalTok{(idx }\SpecialCharTok{\textasciitilde{}}\NormalTok{ Hmisc}\SpecialCharTok{::}\FunctionTok{Cbind}\NormalTok{(}\ConstantTok{NA}\NormalTok{, CI}\FloatTok{.1}\NormalTok{, CI}\FloatTok{.2}\NormalTok{), }\AttributeTok{data =}\NormalTok{ SimData, }\AttributeTok{abline =} \FunctionTok{list}\NormalTok{(}\AttributeTok{v =} \DecValTok{70}\NormalTok{, }
    \AttributeTok{col =} \StringTok{"red"}\NormalTok{, }\AttributeTok{lwd =} \DecValTok{2}\NormalTok{), }\AttributeTok{ylab =} \StringTok{""}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
